...
Status: template
Purpose: Define recurring care that keeps the OS useful, current, and governed.

## Care Package Promise

The AI OS is operational infrastructure, not a one-time prompt setup.
...
- safe
- useful
- aligned to the user's goals
- governed as tools and workflows change
