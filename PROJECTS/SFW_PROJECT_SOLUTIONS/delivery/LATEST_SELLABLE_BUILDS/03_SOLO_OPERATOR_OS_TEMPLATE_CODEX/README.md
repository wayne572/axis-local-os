# Solo Operator OS Template - Codex
...
This is a personal operating system for one person running inside Codex.
...
SOLO_OPERATOR_OS/
  ...
  PLATFORM_NOTES.md
  COMMAND_CENTRE/DAILY_COMMAND_CENTRE.md
  ...
  KNOWLEDGE/PERSONAL_KNOWLEDGE_BASE.md
...
Every Solo build should include:
