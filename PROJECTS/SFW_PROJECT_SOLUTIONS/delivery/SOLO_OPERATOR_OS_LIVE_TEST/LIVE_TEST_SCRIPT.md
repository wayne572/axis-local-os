...
Run these tests in Claude using this live-test folder.
...
Expected result:
- Claude reads `PERSONAL_CONTEXT.md`.
- Claude sees setup is complete.
- Claude does not repeat first-time setup.
- Claude offers main choices: Daily Command Centre, Weekly Review, Capture, Decision Support, Admin Clear-Down, Business Builder.
