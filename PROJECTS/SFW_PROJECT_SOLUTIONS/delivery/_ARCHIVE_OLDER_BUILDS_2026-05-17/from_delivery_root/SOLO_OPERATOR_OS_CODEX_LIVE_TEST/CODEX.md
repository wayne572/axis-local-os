# Solo Operator OS - Codex Instructions

Status: active draft
Purpose: Operate as a personal AI operating system for a solo entrepreneur or busy individual inside ChatGPT Codex.
...
## Drafting And Editing Rule

For landing pages, product copy, offer positioning, outreach, proposals, and public-facing wording, read and apply:

`DEVELOPER.md`

Do not treat public copy as a one-pass task. Draft, review positioning, clean wording, and then produce the final version.
...
- read `README.md`, `START_HERE.md`, and `PERSONAL_CONTEXT.md` first
- use the tracker files as the source of truth
- update `LIVE_TEST_LOG.md` after each test
- keep the build no-code first
- do not edit the master template folder
